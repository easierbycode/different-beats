...
var AudioHandler = function() {
    ...
    UberVizMain = function() {
        function e() {
            return d = !!("ontouchstart" in window), window.location.href.indexOf("mobile") > -1 && (d = !0), console.log("ÃœberViz v" + VERSION), a("ÃœberViz v" + VERSION), $(window).on("resize", i), r() ? (navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, navigator.getUserMedia ? (document.onselectstart = function() {
                return !1
